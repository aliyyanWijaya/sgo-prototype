...
const AROHA_INTRO_SEEN = 'aroha_intro_seen';

// TODO: Record a clear audio clip of "ah-ROH-hah" and save it at:
//   assets/audio/aroha-pronunciation.mp3
// Then replace null with:
//   require('../assets/audio/aroha-pronunciation.mp3')
const PRONUNCIATION_AUDIO: number | null = null;
  ...
  return (
    ...
    <View
      ...
      <Text style={modalStyles.description}>
        ...
        She is your friendly SGO companion — here to help you explore, save, and travel
        with confidence. Ask her anything, any time.
      </Text>
...
function MessageBubble({ message, fontSize }: { message: Message; fontSize: number }) {
  ...
  return (
    <View style={[styles.bubbleRow, isUser ? styles.rowUser : styles.rowAroha]}>
      {!isUser && <ArohaAvatar />}
      <View style={[styles.bubble, isUser ? styles.bubbleUser : styles.bubbleAroha]}>
        <Text
          style={[
            styles.bubbleText,
...
function ErrorBanner({ message, fontSize }: { message: string; fontSize: number }) {
  return (
